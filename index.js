...
base.MethodDefinition = base.ClassMethod = base.Property = base.ClassProperty = base.ObjectProperty = base.ObjectMethod = function (node, st, c) {
  if (node.computed) { c(node.key, st, "Expression"); }
  c(node.value, st, "Expression");
};

base.ClassMethod = function (node, st, c) {
...
base.JSXElement = function(node, st, c){
  ...
  if(node.openingElement.selfClosing === 'false'){
...
base.SpreadElement = base.JSXSpreadAttribute = function(node, st, c){
  c(node.argument, st);
}
base.JSXExpressionContainer = function(node, st, c){
  c(node.expression, st);
}
base.JSXIdentifier = base.JSXEmptyExpression = base.JSXMemberExpression = base.JSXClosingElement = ignore;
base.JSXNamespacedName = base.JSXText = base.JSXClosingFragment = base.JSXOpeningFragment = ignore
